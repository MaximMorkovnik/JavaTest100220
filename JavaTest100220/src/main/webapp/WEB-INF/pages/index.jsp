...
<body>
<div class="container">
    <h3><img height="50" width="55" src="<c:url value="/static/logo.png"/>"/><a href="/">Выпускной тест</a></h3>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul id="groupList" class="nav navbar-nav">
                    ...
                    <li>
                        <button type="button" id="add_group" class="btn btn-default navbar-btn">Введите адрес квартиры</button>
                    </li>
                    <li>
                        <button type="button" id="add_contact" class="btn btn-default navbar-btn">Введите ФИО проживающего</button>
                    </li>
                    <%--                            <li><button type="button" id="delete_group" class="btn btn-default navbar-btn">Delete Group</button></li>--%>

                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                           aria-expanded="false">Выбор квартиры по адресу <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="/">Default</a></li>
                            <c:forEach items="${groups}" var="group">
                                <li><a class="able-be-deleted" href="/group/${group.id}">${group.name}</a>
                                    <button type="button" class="btn-delete-group" value="${group.name}"></button>
                                </li>
                            </c:forEach>
                        </ul>
                    </li>
...
<script>
    ...
    $('.btn-delete-group').click(function () {
        ...
        $.post("/group_delete", groupName, function (groupName, status) {
            window.location.reload();
        });
    });
</script>
